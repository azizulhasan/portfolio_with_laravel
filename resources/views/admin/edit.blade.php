        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li><a class="nav-link active" data-toggle="tab" href="#tab-1"> add category</a></li>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                ...
                                <form action="{{ URL::to('update/category/'.$users->id) }}" method="post">
                                    @csrf
                                <fieldset>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Name:</label>
                                        <div class="col-sm-10"><input type="text" name="name" value="{{ $users->name }}" class="form-control" placeholder="Category name"></div>
                                    </div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">slug:</label>
                                        <div class="col-sm-10"><input type="text" name="slug" value="{{ $users->slug }}" class="form-control" placeholder="slug"></div>
                                    </div>
