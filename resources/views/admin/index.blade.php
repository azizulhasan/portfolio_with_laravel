                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/profile.jpg') }}">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/a2.jpg') }}">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/a3.jpg') }}">
                                    </a>
                                    <div class="media-body ">
                                        <small class="float-right">2h ago</small>
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/a4.jpg') }}">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/a5.jpg') }}">
                                    </a>
                                    <div class="media-body ">
                                        <small class="float-right">2h ago</small>
                                ...
                                <div class="feed-element">
                                    <a class="float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="{{ asset('frontend/img/a7.jpg') }}">
                                    </a>
                                    <div class="media-body ">
