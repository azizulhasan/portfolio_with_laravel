            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                         ...
                         <a href="{{ URL::to('edit/student/'.$d->id) }}"><button class="btn btn-info btn-xs" type="button">Edit</button></a>
                        <a href="{{ URL::to('view/student/'.$d->id) }}"><button class="btn btn-success btn-xs" type="button">View</button></a>
                        <a href="{{ URL::to('delete/student/'.$d->id) }}"><button class="btn btn-danger btn-xs" type="button">delete</button> </a> 
                </div>
                </div>
            </div>
        </div>
