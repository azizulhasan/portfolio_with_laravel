                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Group:</label>
                                        <div class="col-sm-10"><input type="text" name="group" class="form-control" placeholder="phone"></div>
                                    </div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">year:</label>
                                        <div class="col-sm-10"><input type="text" name="year" class="form-control" placeholder="email"></div>
                                    </div>

                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Board:</label>
                                        <div class="col-sm-10"><input type="text" name="board" class="form-control" placeholder="phone"></div>
                                    </div>
