        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="{{url('admin.insert')}}"><i class="fa fa-desktop"></i> <span class="nav-label">App Views</span>  <span class="float-right label label-primary">Profile</span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="contacts.html">Contacts</a></li>
                            <li><a href="{{url('admin.insert')}}">Profile</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{url('admin.view')}}">Products view</a></li>
                            <li><a href="{{url('admin.allpost')}}">allpost view</a></li>
                            <li><a href="{{url('admin.insert')}}">Product add</a></li>
                            <li><a href="{{url('admin.edit')}}">Product edit</a></li>
                            <li><a href="{{ url('students.create') }}">student add</a></li>
                            <li><a href="{{ url('allcreate.myinformations') }}">myinformations add</a></li>
                            <li><a href="{{ url('allcreate.skills') }}">skills add</a></li>
                            <li><a href="{{ url('allcreate.portfolios') }}">portfolios add</a></li>
                            <li><a href="{{ url('allcreate.experiences') }}">experiences add</a></li>
                            <li><a href="{{ url('allcreate.certifications') }}">educations add</a></li>
                            <li><a href="{{ url('allcreate.testimonials') }}">testimonials add</a></li>
                            <li><a href="{{ url('allcreate.contacts') }}">contacts add</a></li>
                            <li><a href="{{ url('allcreate.usercontacts') }}">usercontacts add</a></li>
                            <li><a href="{{ url('allcreate.profilecategories') }}">profilecategories add</a></li>
                            <li><a href="{{ url('allcreate.abouts') }}">abouts add</a></li>
                            <li><a href="{{ url('allcreate.alldescriptions') }}">alldescriptions add</a></li>
                            <li><a href="{{ url('allcreate.hometitles') }}">hometitles add</a></li>
                            <li><a href="{{ url('students.allstudents') }}">student view</a></li>
