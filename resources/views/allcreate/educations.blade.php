                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Group:</label>
                                        <div class="col-sm-10"><input type="text" name="group" class="form-control" placeholder="group"></div>
                                    </div>
                                          ...
                                          <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                            ...
                                            {{-- {{ $user->address }} --}}
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-right">
                                                      <div class="btn-group">
                                                         <a href="{{ URL::to('admin/profileview/'.$data->id) }}"><button class="btn-white btn btn-xs">View</button></a>
                                                         <a href="{{ URL::to('delete/category/'.$data->id) }}"><button class="btn-white btn btn-xs">Delete</button></a>
                                                         <a href="{{ URL::to('edit/category/'.$data->id) }}"><button class="btn-white btn btn-xs">Edit</button></a>
