        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a class="nav-link active" data-toggle="tab" href="#tab-1"> add abouts</a></li>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                ...
                                <form action="{{ route('store.abouts') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <fieldset>
                        ...
                        <div id="tab-2" class="tab-pane">
                                          ...
                                          <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                            ...
                                            {{-- {{ $user->address }} --}}
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-right">
                                                      <div class="btn-group">
                                                         <a href="{{ URL::to('view/abouts/'.$data->id) }}"><button class="btn-white btn btn-xs">View</button></a>
                                                         <a href="{{ URL::to('edit/abouts/'.$data->id) }}"><button class="btn-white btn btn-xs">Edit</button></a>
                                                         <a href="{{ URL::to('delete/abouts/'.$data->id) }}"><button class="btn-white btn btn-xs">Delete</button></a>
                                                      </div>
                                                  </td>
                                              </tr>
                                              @endforeach
                          ...
                          <div id="tab-3" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <form action="{{URL::to('update/abouts/'.$edit->id)  }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <fieldset>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">title:</label>
